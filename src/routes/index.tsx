...
function HomePage() {
	const recommendedPlaylists = [
		{
			id: 1,
			title: "秘封俱乐部",
			coverUrl: "https://placehold.co/200x200/red/white?text=秘封俱乐部",
			creator: "紫妈",
		},
		{
			id: 2,
			title: "幻想乡民谣",
			coverUrl: "https://placehold.co/200x200/red/white?text=幻想乡民谣",
			creator: "灵梦",
		},
		{
			id: 3,
			title: "红魔馆之夜",
			coverUrl: "https://placehold.co/200x200/red/white?text=红魔馆之夜",
			creator: "蕾米莉亚",
		},
		{
			id: 4,
			title: "妖怪山电音",
			coverUrl: "https://placehold.co/200x200/red/white?text=妖怪山电音",
			creator: "天子",
		},
		{
			id: 5,
			title: "永夜的幻想",
			coverUrl: "https://placehold.co/200x200/red/white?text=永夜的幻想",
			creator: "辉夜",
		},
	]
	...
	const banners = [
		{
			id: 1,
			imageUrl: "https://placehold.co/1200x300/red/white?text=东方同音鉴新发布",
			title: "东方同音鉴新发布",
		},
		{
			id: 2,
	...
	// 选择当前显示的轮播图
	const currentBanner = createMemo(
		() => banners[0] || { imageUrl: "", title: "" },
	)
