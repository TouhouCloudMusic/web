  ...
  schemas: {
    ...
    Data_EventResponse: {
      ...
      data: {
        ...
        description: string
        start_date?: [string, "Day" | "Month" | "Year"] | null
        end_date?: [string, "Day" | "Month" | "Year"] | null
    ...
    Data_Label: {
      ...
      data: {
        ...
        id: number
        name: string
        founded_date?: [string, "Day" | "Month" | "Year"] | null
        dissolved_date?: [string, "Day" | "Month" | "Year"] | null
        founders: number[]
