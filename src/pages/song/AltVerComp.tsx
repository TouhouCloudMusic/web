import { altVersTest, grayLinkClass } from "./_Main";

export function AltVerComp() {
	const altVerList = altVersTest.map((version) => {
		return (
			<>
	...
	return (
		<>
			<div class="my-1.5 flex w-auto items-baseline justify-between">
				...
				<p class={grayLinkClass + ""}>view main song</p>
			</div>
			<ul class="altVerWrapper flex w-auto flex-col flex-nowrap bg-zinc-200 pt-1">
				...
				<li class="altVerBottomButton mt-1.5 items-center bg-blue-500 p-0 text-center hover:bg-blue-600">
