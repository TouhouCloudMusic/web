...
import type { ArtistFormHelper, InitData } from "./helpers"

export function insertPerson(tx: Transaction, formData: ArtistFormHelper) {
	return e
 ...
 */
export async function linkMemberOf(
	tx: Transaction,
	formData: ArtistFormHelper
) {
