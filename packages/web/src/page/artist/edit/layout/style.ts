...
const input_tw = "rounded border-[0.1rem] border-gray-300 px-1 h-fit"
export { input_tw as input }

const search_result_tw =
	"w-full rounded border border-gray-300 bg-white px-2 mt-1"
export { search_result_tw as search_result }

const alias_layout_tw = "flex place-content-between min-h-48"
